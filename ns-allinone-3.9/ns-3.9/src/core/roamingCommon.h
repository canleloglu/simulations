#ifndef NS3_ROAMINGCOMMON_H
#define NS3_ROAMINGCOMMON_H
...
std::string g_folderName = "tcpExamples/roamingSimulation/";
#define g_mStep 100
...
#define g_protocolToTest "Roaming"
#define g_packetToServerSize 512
#define g_packetToClientSize 512

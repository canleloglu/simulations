#ifndef NS3_SEAMLESSCOMMON_H
#define NS3_SEAMLESSCOMMON_H
...
#define g_protocolToTest "Disconnection"
#define g_packetToServerSize 512
#define g_packetToClientSize 384

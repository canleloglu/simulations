...
PacketMetadata::GetTotalSize (void) const
{
  ...
  return totalSize;
	...
	void PacketMetadata::SetUid (uint64_t val)
	{
		m_packetUid = val;
	}
    
    std::string PacketMetadata::GetProtocol(void) const
    {
        return m_protocol;
    }
    
    void PacketMetadata::SetProtocol(std::string val)
    {
        m_protocol = val;
    }
    
    string PacketMetadata::GetOrgClient() const
    {
        return m_orgClient;
    }
    
    string PacketMetadata::GetOrgAp() const
    {
        return m_orgAp;
    }
    
    string PacketMetadata::GetOrgGw() const
    {
        return m_orgGw;
    }
    
    string PacketMetadata::GetOrgOp() const
    {
        return m_orgOp;
    }
    
    void PacketMetadata::SetOrgClient(string s){
        m_orgClient = s;
    }
    
    void PacketMetadata::SetOrgAp(string s){
        m_orgAp = s;
    }
    
    void PacketMetadata::SetOrgGw(string s){
        m_orgGw = s;
    }
    
    void PacketMetadata::SetOrgOp(string s){
        m_orgOp = s;
    }

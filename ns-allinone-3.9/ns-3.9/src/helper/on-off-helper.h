...
public:
  ...
  ApplicationContainer Install (std::string nodeName) const;
    ...
    void setPath(Ptr<Application> app, std::string s);
    void setNetworkProtocol(Ptr<Application> app, std::string s);
    string GetOrgClient(Ptr<Application> app);
    string GetOrgAp(Ptr<Application> app);
    string GetOrgGw(Ptr<Application> app);
    string GetOrgOp(Ptr<Application> app);
    void SetOrgClient(Ptr<Application> app, string s);
    void SetOrgAp(Ptr<Application> app, string s);
    void SetOrgGw(Ptr<Application> app, string s);
    void SetOrgOp(Ptr<Application> app, string s);
    void setUserRole(Ptr<Application> app, string s);
    void setClientID(Ptr<Application> app, int i);

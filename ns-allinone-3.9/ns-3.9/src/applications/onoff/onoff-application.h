...
public:
  ...
  void SetMaxBytes (uint32_t maxBytes);
	...
	void setPacketId (uint64_t val);
	void setDirection(std::string s);
	void setNetType(std::string s);
    void setPath(std::string s);
    std::string getNetworkProtocol(void);
    void setNetworkProtocol(std::string val);
    void setUserRole(string val);
    void setClientID(int i);
    
    std::string GetOrgClient();
    std::string GetOrgAp();
    std::string GetOrgGw();
    std::string GetOrgOp();
    void SetOrgClient(std::string s);
    void SetOrgAp(std::string s);
    void SetOrgGw(std::string s);
    void SetOrgOp(std::string s);
...
private:
	...
	uint64_t packetId;
	std::string direction; //gelis ve gidis
	std::string netType; //wifi, csma,  etc
    std::string path; //path identifier

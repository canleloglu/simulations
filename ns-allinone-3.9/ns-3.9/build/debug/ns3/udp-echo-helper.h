...
public:
	...
	void SetKey(Ptr<Application> app, std::string k);
	void setIpv4Addr(Ptr<Application> app, Ipv4Address ad);
	std::string GetKey(Ptr<Application> app);
	void setDelay(Ptr<Application> app, Time t);
...
public:
  ...
  void SetFill (Ptr<Application> app, std::string fill);
	void SetFill (Ptr<Application> app, std::string fill, int nonce);
	void SetKey(Ptr<Application> app, std::string k);
	std::string GetKey(Ptr<Application> app);
	void SetAddr(Ptr<Application> app, Ipv4Address addr);
	int GetCount(Ptr<Application> app);

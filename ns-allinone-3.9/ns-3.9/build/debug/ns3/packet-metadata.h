...
private:
  ...
  uint64_t GetUid (void) const;
	void SetUid (uint64_t val);
    std::string GetProtocol(void) const;
    void SetProtocol(std::string val);
    string GetOrgClient() const;
    string GetOrgAp() const;
    string GetOrgGw() const;
    string GetOrgOp() const;
    void SetOrgClient(string s);
    void SetOrgAp(string s);
    void SetOrgGw(string s);
    void SetOrgOp(string s);

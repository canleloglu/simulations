...
PyTypeObject PyNs3PacketLossCounter_Type = {
    ...
    0,                                 /* ob_size */
    (char *) "ns3.PacketLossCounter",            /* tp_name */
...
PyObject *
_wrap_PyNs3UdpClient_SetRemote(PyNs3UdpClient *self, PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    PyNs3Ipv4Address *ip;
    int port;
...
PyNs3UdpClient__tp_traverse(PyNs3UdpClient *self, visitproc visit, void *arg)
{
    ...
    if (self->obj && typeid(*self->obj) == typeid(PyNs3UdpClient__PythonHelper)  && self->obj->GetReferenceCount() == 1)
...
PyNs3UdpServer__tp_traverse(PyNs3UdpServer *self, visitproc visit, void *arg)
{
    ...
    if (self->obj && typeid(*self->obj) == typeid(PyNs3UdpServer__PythonHelper)  && self->obj->GetReferenceCount() == 1)
        Py_VISIT((PyObject *) self);
...
PyObject *
_wrap_PyNs3UdpTraceClient_SetRemote(PyNs3UdpTraceClient *self, PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    PyNs3Ipv4Address *ip;
    int port;
...
PyNs3UdpTraceClient__tp_traverse(PyNs3UdpTraceClient *self, visitproc visit, void *arg)
{
    ...
    if (self->obj && typeid(*self->obj) == typeid(PyNs3UdpTraceClient__PythonHelper)  && self->obj->GetReferenceCount() == 1)
        Py_VISIT((PyObject *) self);
...
PyTypeObject PyNs3UdpTraceClient_Type = {
    PyObject_HEAD_INIT(NULL)
    0,                                 /* ob_size */
    (char *) "ns3.UdpTraceClient",            /* tp_name */

...
ARFLAGS = 'rcs'
CC = ['/usr/bin/gcc']
CCDEFINES = ['_DEBUG', 'NS3_ASSERT_ENABLE', 'NS3_LOG_ENABLE']
CCDEFINES_ST = '-D%s'
...
COMPILER_CXX = 'g++'
CPP = '/usr/bin/cpp'
CPPPATH_PYEMBED = ['/System/Library/Frameworks/Python.framework/Versions/2.6/include/python2.6']
CPPPATH_PYEXT = ['/System/Library/Frameworks/Python.framework/Versions/2.6/include/python2.6']
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES = ['NS3_ASSERT_ENABLE', 'NS3_LOG_ENABLE']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-Wall', '-g', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
CXXFLAGS_DEBUG = ['-g']
...
HAVE_UINT128_T = ()
HAVE___UINT128_T = 1
LIBPATH_PYEMBED = ['/System/Library/Frameworks/Python.framework/Versions/2.6/lib']
LIBPATH_PYEXT = ['/System/Library/Frameworks/Python.framework/Versions/2.6/lib']
LIBPATH_PYTHON2.6 = ['/System/Library/Frameworks/Python.framework/Versions/2.6/lib']
LIBPATH_ST = '-L%s'
LIB_PYEMBED = ['dl', 'python2.6']
LIB_PYEXT = ['dl', 'python2.6']
...
NS3_BUILDDIR = '/Users/canleloglu/ns-allinone-3.9/ns-3.9/build'
...
REGRESSION_TRACES = '/Users/canleloglu/ns-allinone-3.9/ns-3.9-ref-traces'
RPATH_ST = '-Wl,-rpath,%s'
SHLIB_MARKER = ''
SONAME_ST = ''
SQLITE_STATS = True

...
int main (int argc, char *argv[])
{
  ...
  apps.Stop (Seconds (10.0));
	...
	ApplicationContainer serverApps = echoServer.Install (ap.Get (1));
	...
	ApplicationContainer clientApps = echoClient.Install (ap.Get(0));
	clientApps.Start (Seconds (2.0));
	clientApps.Stop (Seconds (10.0));*/
	
	
	wifiPhy.EnablePcapAll("albeniulan");

...
main (int argc, char *argv[])
{
	...
	ofstream out;
	out.open("tcpExamples/ClientToTTP/srcCsma/10_1_3_1.txt");
	out.close();
	ofstream out2;
	out2.open("tcpExamples/ClientToTTP/destCsma/10_1_3_3.txt");
	out2.close();
  ...
  csmaInterfaces = address.Assign (csmaDevices);
	...
	string line;
	ifstream input;
	input.open("tcpExamples/ClientToTTP/destMesh/10_1_3_21.txt");

...
main (int argc, char *argv[])
{
    ...
    string _out = folderName + "4destCsma/10_1_3_1.txt";
    out.open(_out.c_str());
    out.close();
    string _out2 = folderName + "4destCsma/10_1_3_2.txt";
    out2.open(_out2.c_str());
    out2.close();
    string _out3 = folderName + "4srcCsma/10_1_3_1.txt";
    out3.open(_out3.c_str());
    out3.close();
    string _out4 = folderName + "4srcCsma/10_1_3_2.txt";
    ...
    string line;
    ifstream input;
    string _input = folderName + "3destCsma/10_1_3_2.txt";
    ...
    packetSinkHelper.setAddr(serverApps.Get(0), csmaInterfaces.GetAddress(0));
    ...
    while(getline(input, line))
    {
        if(line.length() > 10){
            ...
            onOffHelper.setAddr(clientApps.Get(0), csmaInterfaces.GetAddress(1));

...
{    
    ...
    string _out = folderName + "5destMesh/10_1_3_1.txt";
    out.open(_out.c_str());
    out.close();
    string _out2 = folderName + "5destMesh/10_1_3_3.txt";
    out2.open(_out2.c_str());
    out2.close();
    string _out3 = folderName + "5srcMesh/10_1_3_1.txt";
    out3.open(_out3.c_str());
    out3.close();
    string _out4 = folderName + "5srcMesh/10_1_3_3.txt";
    ...
    packetSinkHelper.setAddr(serverApps.Get(0), interfaces.GetAddress(0));
    packetSinkHelper.setPath(serverApps.Get(0), folderName + "5destMesh/");
    serverApps.Start (Seconds (1.0));
    serverApps.Stop (Seconds (m_totalTime));
    
    ifstream input;
    string _input = folderName + "4destCsma/10_1_3_1.txt";
    ...
    while(getline(input, line))
    {
        ...
        onOffHelper.setAddr(clientApps.Get(0), interfaces.GetAddress(2));

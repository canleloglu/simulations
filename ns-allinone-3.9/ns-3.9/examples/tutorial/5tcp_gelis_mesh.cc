...
MeshTest::InstallApplication ()
{
	...
	ofstream out;
	out.open("tcpExamples/TTPToClient/srcMesh/10_1_3_2.txt");
	out.close();
	ofstream out2;
	out2.open("tcpExamples/TTPToClient/destMesh/10_1_3_21.txt");
	out2.close();
	...
	ifstream input;
	input.open("tcpExamples/TTPToClient/destCsma/10_1_3_3.txt");
	int dummy = 10000;
